...
'''
'''        
string = "wanting to test this sentence out. and also testing this out"
...
def count_unique (string):
    ...
    cnt_lst = []
    for ch in string:
        if ch not in unique_lst:
            unique_lst.append(ch)
            cnt_lst.append(string.count(ch))
    return unique_lst, cnt_lst
s = 'This is a string, we want you to count how many times each unique character appears in this string!'
